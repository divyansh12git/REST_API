...
app.get("/filter",(req,res)=>{
  ...
  const filteredActivities=jokes.filter((typ)=>typ.jokeType===type);
...
//   const id=parseInt(req.params.id);
//   const existjoke=jokes.find((joke)=>{
//     joke.id===id;
//   });
//   console.log(existjoke);
//   if(req.body.text){
    // existjoke.jokeText=req.body.text;
  // }
  // if(req.body.type){
  //   jokeIndex.jokeType=req.body.text;
  // }
  // res.json(jokeIndex);
// })
